...
function ignition_scripts() {
	...
	wp_enqueue_style( 'ignition-sass-styles', get_theme_file_uri( '/assets/dist/css/main.min.css' ), '', wp_get_theme()->get( 'Version' ) );
	...
	wp_enqueue_script( 'ignition-custom-js', get_template_directory_uri() . '/assets/dist/js/custom.bundle.js', array( 'jquery' ),
...
function ign_gutenberg_styles() {
	...
	wp_enqueue_style( 'ign-gutenberg-style', get_theme_file_uri( '/assets/dist/css/gutenberg-editor-style.min.css' ), false, wp_get_theme()->get( 'Version' ), 'all' );
...
function my_login_styles() {
	wp_enqueue_style( 'custom-login', get_stylesheet_directory_uri() . '/assets/dist/css/login-style.min.css' );
}
...
function footer_styles() {
	wp_enqueue_style( 'ignition-admin-styles', get_theme_file_uri( '/assets/dist/css/admin.min.css' ), '', wp_get_theme()->get( 'Version' ) );
}
